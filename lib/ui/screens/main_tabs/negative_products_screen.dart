...
class NegativeProductsScreen extends StatelessWidget {
  const NegativeProductsScreen({super.key});
        ...
        Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                'На что у вас аллергия или какие продукты вы не хотите видеть в рационе?',
